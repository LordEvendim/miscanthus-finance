...
interface BoughtContractItemProps {
...
export const BoughtContractItem: React.FC<BoughtContractItemProps> = ({
  contractId,
  contractPrice,
  quantity,
  settlementEpoch,
    ...
    >
      ...
      >
        ...
        <Button
          ...
          onClick={() => useCoreContract.getState().settleContract(contractId)}
          disabled={expirationDate > Date.now()}
        >
