            ...
            >
              ...
              <Box p={"20px"} fontWeight={"bold"} fontSize={"xl"}>
                ...
                <Text
                  ...
                  opacity={"0.6"}
                >
                  Trade and write expirable futures contracts. Manage and
                  trasfer your positions as they are represented as NFT tokens.
                </Text>
              </Box>
            </Box>
            ...
            >
              ...
              <Box p={"20px"} fontWeight={"bold"} fontSize={"xl"}>
                ...
                <Text
                  ...
                  opacity={"0.6"}
                >
                  Decentralized auction house that can be used to auction and
                  sell your futures contracts before the expiration date
                </Text>
              </Box>
            </Box>
          </HStack>
