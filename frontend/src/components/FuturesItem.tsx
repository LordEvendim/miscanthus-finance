...
export const FuturesItem: React.FC<FuturesItemProps> = ({
  contractId,
  contractPrice,
  quantity,
  settlementEpoch,
  ...
  const buyContract = useCoreContract((state) => state.buyContract);
    ...
    >
      ...
      >
        ...
        <Button
          ...
          onClick={() => buyContract(contractId)}
        >
